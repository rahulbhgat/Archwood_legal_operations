...
from services.gemini_llm import query_gemini  # ✅ Use Groq-hosted GPU LLM
    ...
    if uploaded_file:
        ...
        if st.button("📤 Generate Client Brief"):
            with st.spinner("Creating brief..."):
                ...
                client_brief = query_gemini(prompt)
